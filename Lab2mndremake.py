...
def lab(m):
	romanovskii = {5:2.0, 6:2.0, 7:2.0, 8:2.17, 9:2.17, 10:2.29, 11:2.29, 12:2.39, 13:2.39, 14:2.49, 15:2.49, 16:2.49, 17:2.49, 18:2.62, 19:2.62, 20:2.62}
	rom = romanovskii[m]
	...
	if R1<rom and R2<rom and R3<rom:
		print('Дисперсія однорідна')
		print(round(R1, 1), '< Rkr =', rom)
		print(round(R2, 1), '< Rkr =', rom)
		print(round(R3, 1), '< Rkr =', rom)
		print('-----------------------------------------------------------------------------')
